...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('subkriteria.index', $kriteria->id) }}" class="btn btn-sm btn-danger mb-3"
                    role="button">
                    <i class="fa fa-arrow-left"></i>
                    {{__('Kembali')}}
                </a>
                <form action="{{ route('bobotsubkriteria.index', $kriteria->id) }}" method="post">
                    @csrf
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <div class="field">
                                    @php
                                    $nilai = $spk->getNilaiPerbandinganSubkriteria($data[$x]->id, $data[$y]->id);
                                    @endphp
