    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4>{{ucfirst($title)}} &rarr; {{$dataKriteria->nama}}</h4>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('bobotalternatif.index', $kode) }}" method="post">
                    @csrf
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <div class="field">
                                    @php
                                    $nilai = $spk->getNilaiPerbandinganAlternatif($data[$x]->id, $data[$y]->id,
                                    $dataKriteria->kode);
                                    @endphp
